...
import IALang2 as IALang2
import streamlit as st
from streamlit_chat import message

st.title("App Chatbot EBI")
st.write("Puedes hacerme a mi todas las preguntas y  sobre la infotmacion Financiera del EBI")
...
def click():
    if st.session_state.user != '':
        ...
        respuesta = IALang2.NL2SQL(pregunta)
