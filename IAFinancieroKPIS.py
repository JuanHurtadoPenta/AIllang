...
def devolver_Analisis(human_query,tabla):
    print("VAMOS A DEVOLVER ANALISIS")
    print(human_query)
...
*** la siguiente tabla tiene algunas columnas,las mas importantes son la de valor y valor acumulado, dependiendo de si el cliente busca o no el valor acumulado  daras tu respuesta: ***:
1. Si el cliente busca el  "acumulado" o "acumulada" en su consulta, tu respuesta sera la misma tabla **pero sin  la columna "valor"**
2. Si el cliente **no menciona** la palabra "acumulado" o"acumulada" o **no busca**ese valor , tu respuesta sera la misma tabla **pero sin  la columna"valor_acumulado" ** 
...
"""
    ...
    prompt3="""Tu respuesta DEBE estar en ESPAÑOL. a manera de tabla pero en un** solo string**. El formato esperado es el siguiente:
...
#consulta = "cual es el  Período medio de cobros (días) de los meses del  año 2023 de la empresa ktm "
